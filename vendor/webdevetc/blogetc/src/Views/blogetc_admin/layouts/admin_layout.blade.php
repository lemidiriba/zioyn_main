...
<head>
    ...
    <!-- Styles -->
    <!--@if(file_exists(public_path('./css/blogetc_admin_css.css')))-->
    <link href="{{ asset('./css/blogetc_admin_css.css') }}" rel="stylesheet">
    <!--@else-->
...
<body>
    ...
    <div id="app">
        ...
        {{-- <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background-color:#020230">
            <div class="container">
    ...
    @if( config("blogetc.use_wysiwyg") && config("blogetc.echo_html") && (in_array( Request::route()->getName() ,[
    'blogetc.admin.create_post' , 'blogetc.admin.edit_post' ])))
    <script src="https://cdn.ckeditor.com/4.14.1/standard/ckeditor.js"
        integrity="sha256-wURXWeMdyFKDl3v/rGzRT42o2lslbozA3ppL/M7ZVGI=" crossorigin="anonymous"></script>
