        ...
        <div>
            ...
            <div class="list-group ">
                <a href="{{ route('blogetc.admin.comments.index') }}"
                    class="list-group-item list-group-item-action  @if(Request::route()->getName() === 'blogetc.admin.comments.index' && !Request::get("
                    waiting_for_approval")) active @endif ">
                ...
                <a href="{{ route('blogetc.admin.comments.index') }}?waiting_for_approval=true"
                    class="list-group-item list-group-item-action  @if(Request::route()->getName() === 'blogetc.admin.comments.index' && Request::get("
                    waiting_for_approval")) active @elseif($comment_approval_count>0) list-group-item-warning @endif ">
                    <i class="fa  fa-fw fa-comments" aria-hidden="true"></i>
